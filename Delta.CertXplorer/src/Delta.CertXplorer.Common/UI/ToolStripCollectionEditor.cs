...
namespace Delta.CertXplorer.UI
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolStripCollectionEditor"/> class.
        /// </summary>
        public ToolStripCollectionEditor() : base(typeof(ToolStripItemCollection)) { }

        protected override object CreateInstance(Type itemType)
        {
            //MessageBox.Show(itemType.ToString());
    ...
    internal class ToolStripCollectionEditor : CollectionEditor
    {
                ...
                switch (m.Msg)
                {
                    case 0x100:
                        ...
                        if ((((int)m.WParam) == 0xe5) && (this.PropertyGrid != null))
                        {
                            ...
                            {
                                NativeMethods.SendMessage(UnsafeNativeMethods.GetFocus(), 0x100, this.lastKeyDown.WParam, this.lastKeyDown.LParam);
                            }
                        }
                        break;
                    ...
                    case 0x102:
                        {
                            ...
                            NativeMethods.SendMessage(focus, 0x100, this.lastKeyDown.WParam, this.lastKeyDown.LParam);
                            NativeMethods.SendMessage(focus, 0x102, m.WParam, m.LParam);
                            return;
                        }
                }
                base.WndProc(ref m);
        ...
        protected class ToolStripItemEditorForm : CollectionEditor.CollectionForm
        {
            ...
            private FilterListBox listBoxItems;
            ...
            private void OnFormLoad(object sender, EventArgs e)
            {
                ...
                if (instance != null)
                {
                    Type[] standardItemTypes = ToolStripDesignerUtils.GetStandardItemTypes(instance);
                    this.newItemTypes.Items.Clear();
                    foreach (Type type in standardItemTypes)
                    {
                ...
                if (e.Index != -1)
                {
                    ...
                    if (itemType != null)
                    {
                        ...
                        if (!string.IsNullOrEmpty(str))
                        {
                            ...
                            TextRenderer.DrawText(e.Graphics, str, this.Font, rectangle2, empty, glyphOverhangPadding);
                        }
            ...
            private void OnselectedItemName_Paint(object sender, PaintEventArgs e)
            {
                using (Font font = new Font(this.selectedItemName.Font, FontStyle.Bold))
                {
                    ...
                    switch (this.listBoxItems.SelectedItems.Count)
                    {
                        case 0:
                            ...
                            e.Graphics.DrawString(SR.GetString("ToolStripItemCollectionEditorLabelNone"), font, SystemBrushes.WindowText, clientRectangle, format);
                            return;
                ...
                Label_0215:
                    ...
                    e.Graphics.DrawString(SR.GetString("ToolStripItemCollectionEditorLabelMultipleItems"), font, SystemBrushes.WindowText, clientRectangle, format);
                }
            }
                    ...
                    if (value != this._targetToolStripCollection)
                    {
                        ...
                        if (value != null)
                        {
                            if (base.Context != null)
                            {
                                ...
                                this.selectedItemProps.Site = new PropertyGridSite(base.Context, this.selectedItemProps);
                            }
                        }
                        else
                        {
