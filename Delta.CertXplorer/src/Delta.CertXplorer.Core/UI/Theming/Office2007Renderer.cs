...
namespace Delta.CertXplorer.UI.Theming
{
    ...
    internal class Office2007Renderer : ToolStripProfessionalRenderer
    {
        ...
        /// <summary>
        /// Set the SmoothingMode=AntiAlias until instance is disposed.
        /// </summary>
        private class UseAntiAlias : IDisposable
        {
            ...
            /// <summary>
            /// Reverts the SmoothingMode back to its original setting.
            /// </summary>
            public void Dispose() { g.SmoothingMode = oldSmoothingMode; }
        }

        /// <summary>
        /// Set the TextRenderingHint.ClearTypeGridFit until instance disposed.
        /// </summary>
        private class UseClearTypeGridFit : IDisposable
        {
            private Graphics g = null;
            private TextRenderingHint oldTextRenderingHint;
            ...
            /// </summary>
            public void Dispose() { g.TextRenderingHint = oldTextRenderingHint; }
        }

        /// <summary>
        /// Set the clipping region until instance disposed.
        /// </summary>
        private class UseClipping : IDisposable
        {
            private Graphics g = null;
            ...
            /// </summary>
            public void Dispose() { g.Clip = oldRegion; }
        }
        ...
        private static int gripOffset = 1;
        private static int gripSquare = 2;
        private static int gripSize = 3;
        private static int gripMove = 4;
        private static int gripLines = 3;
        private static int checkInset = 1;
        private static int marginInset = 2;
        private static int separatorInset = 31;
        private static float cutToolItemMenu = 1.0f;
        private static float cutContextMenu = 0f;
        private static float cutMenuItemBack = 1.2f;
        private static float contextCheckTickThickness = 1.6f;
        private static Blend statusStripBlend = null;

        #endregion

        private static Office2007Renderer certXplorerRenderer = null;
        private static Office2007Renderer blueRenderer = null;

        #region Palette

        private Color _disabledTextColor = Color.FromArgb(167, 167, 167);
        private Color _textColor = Color.FromArgb(21, 66, 139);
        private Color _c3 = Color.FromArgb(76, 83, 92);
        private Color _c4 = Color.FromArgb(250, 250, 250);
        private Color _c5 = Color.FromArgb(248, 248, 248);
        private Color _c6 = Color.FromArgb(243, 243, 243);
        private Color _r1 = Color.FromArgb(255, 255, 251);
        private Color _r2 = Color.FromArgb(255, 249, 227);
        private Color _r3 = Color.FromArgb(255, 242, 201);
        private Color _r4 = Color.FromArgb(255, 248, 181);
        private Color _r5 = Color.FromArgb(255, 252, 229);
        private Color _r6 = Color.FromArgb(255, 235, 166);
        private Color _r7 = Color.FromArgb(255, 213, 103);
        private Color _r8 = Color.FromArgb(255, 228, 145);
        private Color _r9 = Color.FromArgb(160, 188, 228);
        private Color _rA = Color.FromArgb(121, 153, 194);
        private Color _rB = Color.FromArgb(182, 190, 192);
        private Color _rC = Color.FromArgb(155, 163, 167);
        private Color _rD = Color.FromArgb(233, 168, 97);
        private Color _rE = Color.FromArgb(247, 164, 39);
        private Color _rF = Color.FromArgb(246, 156, 24);
        private Color _rG = Color.FromArgb(253, 173, 17);
        private Color _rH = Color.FromArgb(254, 185, 108);
        private Color _rI = Color.FromArgb(253, 164, 97);
        private Color _rJ = Color.FromArgb(252, 143, 61);
        private Color _rK = Color.FromArgb(255, 208, 134);
        private Color _rL = Color.FromArgb(249, 192, 103);
        private Color _rM = Color.FromArgb(250, 195, 93);
        private Color _rN = Color.FromArgb(248, 190, 81);
        private Color _rO = Color.FromArgb(255, 208, 49);
        private Color _rP = Color.FromArgb(254, 214, 168);
        private Color _rQ = Color.FromArgb(252, 180, 100);
        private Color _rR = Color.FromArgb(252, 161, 54);
        private Color _rS = Color.FromArgb(254, 238, 170);
        private Color _rT = Color.FromArgb(249, 202, 113);
        private Color _rU = Color.FromArgb(250, 205, 103);
        private Color _rV = Color.FromArgb(248, 200, 91);
        private Color _rW = Color.FromArgb(255, 218, 59);
        private Color _rX = Color.FromArgb(254, 185, 108);
        private Color _rY = Color.FromArgb(252, 161, 54);
        private Color _rZ = Color.FromArgb(254, 238, 170);

        // Color scheme values
        private Color _textDisabled;
        private Color _textMenuStripItem;
        private Color _textStatusStripItem;
        private Color _textContextMenuItem;
        private Color _arrowDisabled;
        private Color _arrowLight;
        private Color _arrowDark;
        private Color _separatorMenuLight;
        private Color _separatorMenuDark;
        private Color _contextMenuBack;
        private Color _contextCheckBorder;
        private Color _contextCheckTick;
        private Color _statusStripBorderDark;
        private Color _statusStripBorderLight;
        private Color _gripDark;
        private Color _gripLight;
        private GradientItemColors _itemContextItemEnabledColors;
        private GradientItemColors _itemDisabledColors;
        private GradientItemColors _itemToolItemSelectedColors;
        private GradientItemColors _itemToolItemPressedColors;
        private GradientItemColors _itemToolItemCheckedColors;
        private GradientItemColors _itemToolItemCheckPressColors;
        ...
        static Office2007Renderer()
        {
            ...
            statusStripBlend.Positions = new float[] { 0.0f, 0.25f, 0.25f, 0.57f, 0.86f, 1.0f };
            statusStripBlend.Factors = new float[] { 0.1f, 0.6f, 1.0f, 0.4f, 0.0f, 0.95f };
        }

        public static Office2007Renderer CertXplorer
        {
            get
            {
        ...
        public static Office2007Renderer Office2007Blue
        {
            get 
            {
                if (blueRenderer == null) blueRenderer = new Office2007Renderer(false, 
                    Office2007ColorTable.Blue);
                return blueRenderer;
            }
        }
                        ...
                        switch (checkState)
                        {
                            case CheckState.Checked:
                                ...
                                using (GraphicsPath tickPath = CreateTickPath(checkBox))
                                {
                                    ...
                                    using (Pen tickPen = new Pen(_contextCheckTick,contextCheckTickThickness))
        ...
        protected override void OnRenderItemText(ToolStripItemTextRenderEventArgs e)
        {
             ...
             (e.ToolStrip is ToolStripDropDownMenu))
            {
                ...
                // ODT: we don't want to use the ClearTypeGridFit text rendering hint
                // for these items because, the text is truncated.
                if (e.Item is ToolStripLabel) base.OnRenderItemText(e);
                // All text is draw using the ClearTypeGridFit text rendering hint
                else using (new UseClearTypeGridFit(e.Graphics)) base.OnRenderItemText(e);
            }
                ...
                (e.ToolStrip is ToolStripDropDownMenu))
            {
                            ...
                            darkPen = new Pen(_separatorMenuDark))
                {
                    DrawSeparator(e.Graphics, e.Vertical, e.Item.Bounds, 
                                  lightPen, darkPen, separatorInset,
                                               ...
                                               GradientItemColors colorsSplit)
        {
                ...
                (backRect.Height > 0) && (backRectDrop.Height > 0))
            {
                ...
                using (GraphicsPath borderPath = CreateBorderPath(backRect, cutMenuItemBack))
                {
        ...
        private void DrawContextMenuHeader(Graphics g, ToolStripItem item)
        {
            ...
            // Create border and clipping paths
            using (GraphicsPath borderPath = CreateBorderPath(itemRect, cutToolItemMenu),
                                insidePath = CreateInsideBorderPath(itemRect, cutToolItemMenu),
                                  clipPath = CreateClipBorderPath(itemRect, cutToolItemMenu))
            {
                // Clip all drawing to within the border path
